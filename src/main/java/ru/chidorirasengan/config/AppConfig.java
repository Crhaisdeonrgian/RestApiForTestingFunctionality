...
@ComponentScans(value = { @ComponentScan("ru.chidorirasengan.*")})
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setAnnotatedClasses(User.class, Authorities.class, Product.class,Order.class, ShoppingCart.class);
